...
|====================================
|id Test |nom Test | Nom cas d’utilisation |Conditions de satisfaction |Préconditions
| A3 | Test Débit/Crédit/Virement | Débit/Crédit/Virement  | Pour pouvoir cloturer un compte d'un client. Ne peut être réouvert si il est cloturer | Compte déja existant et non cloturer. Compte avec solde à 0.
|====================================
