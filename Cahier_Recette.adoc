...
|====================================
|id Test |nom Test | Nom cas d’utilisation |Conditions de satisfaction |Préconditions
| A3 | Test Débit/Crédit/Virement | Débit/Crédit/Virement  | Pour pouvoir Débit/Crédit/Virement  un compte d'un client.  | Débit : ne peut dépasser le découvert. Credit : Maximum 1 millions. Virement ne pouvant etre effectuer sur un compte cloturer et ne peut dépasser le découvert
|====================================
