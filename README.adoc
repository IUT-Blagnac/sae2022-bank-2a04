...
|         | `jar` projet |https://github.com/IUT-Blagnac/sae2022-bank-2a04/blob/main/Daily_Bank.jar     |
|12/06   | Gantt V3 à Jour  |https://github.com/IUT-Blagnac/sae2022-bank-2a04/blob/main/Documents%20Finaux/Gantt%20V3.pdf    |  
...
=== Tableau de récapitulatif des taches de dev fait par chacun

|===
| Fonctionnalité | Personne qui l'a écrite
| Viremenent | Romain Massip
| Crédit | Romain Massip
| Nouveau compte | Romain Massip
| gérer employé (tout ce qui est en rapport avec employé) |Jordan Quinveros 
| Générer PDF| Jordan Quinveros
| Cloturer Compte | Jordan Quinveros
| Fonctionnalité supplémentaire (ex: recherche, double clic...) | Jordan Quinveros
|===
