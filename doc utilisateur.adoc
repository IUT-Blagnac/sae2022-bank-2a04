...
image::Image/DocUtilisateur/InterfaceArrive.PNG[width=40%]
...
Puis quand vous vous connectez une interface de connection apparé :

image::Image/DocUtilisateur/Interface connection.PNG[width=30%]
