...
Pour commencer l'installation de l'application ,on commence par lancer le jar. Le projet démarre en lancan le programme principal application.DailyBankApp.
