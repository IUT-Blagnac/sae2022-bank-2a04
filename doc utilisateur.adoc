...
*** 4.5. Rechercher les clients de l'Agence
...
image::Image/DocUtilisateur/AffichageC.PNG[width=40%]

Sélectionné un compte et deux boutons deviennent disponibles

image::Image/DocUtilisateur/BoutonCC.PNG[width=40%]

Se bouton permet d'ouvrir l'interface de gestion des comptes du client sélectionné

image::Image/DocUtilisateur/BoutonMC.PNG[width=40%]
