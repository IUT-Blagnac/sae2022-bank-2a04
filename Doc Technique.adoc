...
Rajouter des fonctionnalité à l’application que nous avons reçu, par exemple: (tout mettre) Simuler une assurance d’emprunt Effectuer un Débit exceptionnel ** Effectuer un virement de compte à compte Ainsi que d’autre fonctionnalité que nous mettrons si le temps nous le permet.
