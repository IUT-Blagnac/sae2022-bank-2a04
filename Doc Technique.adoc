...
Application.view regroupe les fichiers fxml ainsi que leur différents controllers. \r
Application.tools est un package contenant les outils d'alertes, des constantes reutillisables.\r
Application.control permet de gérer les différents fenêtre créer dans le package view.\r
Application permet de lancer les différentes méthodes pour initialiser le lancement de l'application\r
