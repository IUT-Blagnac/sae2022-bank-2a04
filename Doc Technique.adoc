...
Notre application à été écrite en java avec la bibliothèque de javaFX 1.8 qui nous a permis de créer l'interface graphique de l'application, ainsi qu'une base de donnée en SQL oracle qui nous permet de stocker tous les clients de la banques, leurs comptes, leurs transactions...
